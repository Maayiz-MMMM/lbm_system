...
<head>
    ...
    <title>Dashboard - Puttalam Smart Library</title>
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  <?= $currentFilename == 'search_books.php' ? 'active' : '' ?>">
                            <a href="search_books.php" class='sidebar-link'>
                                <i class="bi fa-solid fa-book"></i>
                                <span>Books</span>
                            </a>
                        </li>
                        <li class="sidebar-item  <?= $currentFilename == 'returned_books.php' ? 'active' : '' ?>">
